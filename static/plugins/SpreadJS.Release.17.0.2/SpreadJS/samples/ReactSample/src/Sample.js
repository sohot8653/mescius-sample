    ...
    render(){
        return(
            <div className="app-header">
                <img className="logo" src="./img/favicon.ico" alt="logo"/>
    ...
    render(){
        return(
            <div className="app-footer">
                <span className="footer-text">© 2023 MESCIUS inc. All Rights Reserved. All product and company names herein may be trademarks of their respective owners.</span>
            </div>
        )
    }
}
