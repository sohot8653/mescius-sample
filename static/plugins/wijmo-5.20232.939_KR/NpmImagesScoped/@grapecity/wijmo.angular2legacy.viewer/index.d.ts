/*!
    ...
    */
/**
* {@module wijmo.angular2legacy.viewer}
* Contains Angular 2 components for the <b>wijmo.viewer</b> module.
*
* <b>wijmo.angular2legacy.viewer</b> is an external TypeScript module that can be imported to your code
* using its ambient module name. For example:
*
* <pre>import * as wjViewer from 'wijmo/wijmo.angular2legacy.viewer';
* &nbsp;
* &#64;Component({
