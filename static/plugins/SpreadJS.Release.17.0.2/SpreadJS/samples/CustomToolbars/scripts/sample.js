...
function checkedChanged() {
    ...
    switch (name) {
        ...
        case "scrollbarAppearance":
            spread.options.scrollbarAppearance = value ? 1 : 0;
            break;
...
function syncSpreadPropertyValues() {
    ...
    setCheckValue("scrollbarAppearance", spread.options.scrollbarAppearance);
    // TabStrip
...
function initSpread() {
    ...
    sheet.setValue(2, 1, "This is a web application built with the MESCIUS SpreadJS JavaScript Spreadsheet component. It mimics much of the functionality and UI you see in with Microsoft Windows Store Excel application. This application was built to showcase the features and extensibility you will find in SpreadJS");
...
function exportFile(fileName) {
    ...
    } else if ($("#saveSjs")[0].checked) {
        exportToSJS(fileName);
...
function exportToExcel(fileName) {
    ...
    spread.export(function (blob) {
        ...
        alert(e);
    }, { includeBindingSource: true, password: password });
}
