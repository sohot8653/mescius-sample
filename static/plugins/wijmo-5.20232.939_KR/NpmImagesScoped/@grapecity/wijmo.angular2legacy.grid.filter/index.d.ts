/*!
    ...
    */
/**
* {@module wijmo.angular2legacy.grid.filter}
* Contains Angular 2 components for the <b>wijmo.grid.filter</b> module.
*
* <b>wijmo.angular2legacy.grid.filter</b> is an external TypeScript module that can be imported to your code
* using its ambient module name. For example:
*
* <pre>import * as wjFilter from 'wijmo/wijmo.angular2legacy.grid.filter';
