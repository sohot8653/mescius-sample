...
export declare class WjFlexGridColumn extends wjcGrid.Column implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjFlexGridColumn, [null, null, { optional: true; skipSelf: true; }, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<WjFlexGridColumn, "wj-flex-grid-column", never, { "asyncBindings": "asyncBindings"; "wjProperty": "wjProperty"; "name": "name"; "dataMap": "dataMap"; "dataType": "dataType"; "binding": "binding"; "sortMemberPath": "sortMemberPath"; "format": "format"; "cellTemplate": "cellTemplate"; "header": "header"; "width": "width"; "maxLength": "maxLength"; "minWidth": "minWidth"; "maxWidth": "maxWidth"; "align": "align"; "allowDragging": "allowDragging"; "allowSorting": "allowSorting"; "allowResizing": "allowResizing"; "allowMerging": "allowMerging"; "aggregate": "aggregate"; "isReadOnly": "isReadOnly"; "cssClass": "cssClass"; "cssClassAll": "cssClassAll"; "isContentHtml": "isContentHtml"; "isSelected": "isSelected"; "visible": "visible"; "wordWrap": "wordWrap"; "multiLine": "multiLine"; "mask": "mask"; "inputType": "inputType"; "isRequired": "isRequired"; "showDropDown": "showDropDown"; "dataMapEditor": "dataMapEditor"; "dropDownCssClass": "dropDownCssClass"; "quickAutoSize": "quickAutoSize"; "editor": "editor"; }, { "initialized": "initialized"; "isSelectedChangePC": "isSelectedChange"; }, never, ["*"], false, never>;
}
...
export declare class WjFlexGridColumnGroup extends wjcGrid.ColumnGroup implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjFlexGridColumnGroup, [null, null, { optional: true; skipSelf: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<WjFlexGridColumnGroup, "wj-flex-grid-column-group", never, { "asyncBindings": "asyncBindings"; "wjProperty": "wjProperty"; "name": "name"; "dataMap": "dataMap"; "dataType": "dataType"; "binding": "binding"; "sortMemberPath": "sortMemberPath"; "format": "format"; "cellTemplate": "cellTemplate"; "header": "header"; "width": "width"; "maxLength": "maxLength"; "minWidth": "minWidth"; "maxWidth": "maxWidth"; "align": "align"; "allowDragging": "allowDragging"; "allowSorting": "allowSorting"; "allowResizing": "allowResizing"; "allowMerging": "allowMerging"; "aggregate": "aggregate"; "isReadOnly": "isReadOnly"; "cssClass": "cssClass"; "cssClassAll": "cssClassAll"; "isContentHtml": "isContentHtml"; "isSelected": "isSelected"; "visible": "visible"; "wordWrap": "wordWrap"; "multiLine": "multiLine"; "mask": "mask"; "inputType": "inputType"; "isRequired": "isRequired"; "showDropDown": "showDropDown"; "dataMapEditor": "dataMapEditor"; "dropDownCssClass": "dropDownCssClass"; "quickAutoSize": "quickAutoSize"; "editor": "editor"; "collapseTo": "collapseTo"; "isCollapsed": "isCollapsed"; "height": "height"; }, { "initialized": "initialized"; "isSelectedChangePC": "isSelectedChange"; }, never, ["*"], false, never>;
}
/**
...
export declare class WjFlexGridCellTemplate implements ngCore.OnInit, ngCore.OnDestroy {
    ...
    */
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjFlexGridCellTemplate, [null, { optional: true; }, null, { optional: true; skipSelf: true; }, null, null]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<WjFlexGridCellTemplate, "[wjFlexGridCellTemplate]", ["wjFlexGridCellTemplate"], { "wjFlexGridCellTemplate": "wjFlexGridCellTemplate"; "cellTypeStr": "cellType"; "cellOverflow": "cellOverflow"; "valuePaths": "valuePaths"; "autoSizeRows": "autoSizeRows"; "forceFullEdit": "forceFullEdit"; }, {}, never, never, false, never>;
}
...
export declare class WjGridModule {
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjGridModule, never>;
    static ɵmod: ɵngcc0.ɵɵNgModuleDeclaration<WjGridModule, [typeof WjFlexGrid, typeof WjFlexGridColumn, typeof WjFlexGridColumnGroup, typeof WjFlexGridCellTemplate], [typeof ɵngcc1.CommonModule], [typeof WjFlexGrid, typeof WjFlexGridColumn, typeof WjFlexGridColumnGroup, typeof WjFlexGridCellTemplate]>;
    static ɵinj: ɵngcc0.ɵɵInjectorDeclaration<WjGridModule>;
}
