...
export declare class WjFlexChartRangeSelector extends wjcChartInteraction.RangeSelector implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjFlexChartRangeSelector, [null, null, { optional: true; skipSelf: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<WjFlexChartRangeSelector, "wj-flex-chart-range-selector", never, { "wjProperty": "wjProperty"; "isVisible": "isVisible"; "min": "min"; "max": "max"; "orientation": "orientation"; "seamless": "seamless"; "minScale": "minScale"; "maxScale": "maxScale"; }, { "initialized": "initialized"; "rangeChangedNg": "rangeChanged"; }, never, never, false, never>;
}
...
export declare class WjFlexChartGestures extends wjcChartInteraction.ChartGestures implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngAfterViewInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjFlexChartGestures, [null, null, { optional: true; skipSelf: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<WjFlexChartGestures, "wj-flex-chart-gestures", never, { "wjProperty": "wjProperty"; "mouseAction": "mouseAction"; "interactiveAxes": "interactiveAxes"; "enable": "enable"; "scaleX": "scaleX"; "scaleY": "scaleY"; "posX": "posX"; "posY": "posY"; }, { "initialized": "initialized"; }, never, never, false, never>;
}
export declare class WjChartInteractionModule {
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<WjChartInteractionModule, never>;
    static ɵmod: ɵngcc0.ɵɵNgModuleDeclaration<WjChartInteractionModule, [typeof WjFlexChartRangeSelector, typeof WjFlexChartGestures], [typeof ɵngcc1.CommonModule], [typeof WjFlexChartRangeSelector, typeof WjFlexChartGestures]>;
    static ɵinj: ɵngcc0.ɵɵInjectorDeclaration<WjChartInteractionModule>;
}
