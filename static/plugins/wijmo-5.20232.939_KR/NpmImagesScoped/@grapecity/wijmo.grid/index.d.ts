...
import { Size, CancelEventArgs, NotifyCollectionChangedEventArgs, ObservableArray, Point, Control, Event, EventArgs, _MaskProvider, ICollectionView, DataType, Aggregate, Binding, CollectionViewGroup, Rect, Tooltip, IEditableCollectionView, IBindingInfo } from '@grapecity/wijmo';
...
export declare const colHdrAriaAttributes: (cell: HTMLElement, col: Column, gridPanel: GridPanel, g: FlexGrid, isRowHeader?: boolean) => void;
/**
