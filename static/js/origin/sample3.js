...
function initSpread(spread) {
  ...
  var myView = productTable.addView("myView", [
      ...
      { value: "c3", width: 100, caption :['기본정보', '팀'] },
      ...
      { value: "c9", width: 100, caption :['기본정보', '입사 일자'], style: style},
      ...
      { value: "c20", width: 100, caption :['승급필요점수 달성여부', '미달사유'] },
...
function getData() {
  ...
  for(var i = 1; i < 150; i++) {
      var obj = {};
      obj.c1 = i;
      obj.c3 = ['정보IT팀', '기획팀', '경영관리팀', '인사총무팀'][Math.floor(Math.random() * 4)];
      obj.c4 = Math.floor(Math.random() * (24000000 - 21000000)) + 21000000;
      obj.c5 = ['김', '강', '고', '박', '윤', '이'][Math.floor(Math.random() * 6)] + 'OO';
      var age = '19' + (Math.floor(Math.random() * (99 - 50)) + 50);
      obj.c6 = age;
      obj.c7 = 2024 - age;
      obj.c8 = ['대학교', '전문대학', '대학원', '고등학교'][Math.floor(Math.random() * 4)];
      obj.c9 = getRandomDate(new Date(2000, 1, 1), new Date());
      obj.c10 = Math.floor(Math.random() * 50) + 1;
      var level = getRandomArrayElement([['부장(S3)', '[미대상]'], ['사원(J1)', '26년 사원(J2)'], ['사원(J2)', '28년 사원(J3)'], ['사원(J3)', '27년 대리(J4)'], ['대리(J4)', '30년 대리(J5)']]);;
      obj.c11 = level[0];
      obj.c12 = Math.floor(Math.random() * 10);
      obj.c14 = level[1];
      var a = getRandomArrayElement([['-','-','-','-','-','-'], ['-','O','-','-','O', '호봉'], ['-','O','-','-','O', '누적'], ['-','O','-','O','-']]);
      obj.c15 = a[0];
      obj.c16 = a[1];
      obj.c17 = a[2];
      obj.c18 = a[3];
      obj.c19 = a[4];
      obj.c20 = a[5];
      var b = getRandomArrayElement([['-','-','-','-','-','-', 'D'], ['B','A','A','A','S','B','A'], ['-','-','-','-','A','B','B+'], ['-','-','-','S','A','A', 'A']]);
      obj.c21 = b[0];
      obj.c22 = b[1];
      obj.c23 = b[2];
      obj.c24 = b[3];
