/*!
    ...
    */
/**
* {@module wijmo.angular2legacy.grid.detail}
* Contains Angular 2 components for the <b>wijmo.grid.detail</b> module.
*
* <b>wijmo.angular2legacy.grid.detail</b> is an external TypeScript module that can be imported to your code
* using its ambient module name. For example:
*
* <pre>import * as wjDetail from 'wijmo/wijmo.angular2legacy.grid.detail';
...
import { IWjComponentMetadata, IWjDirectiveMeta } from '@grapecity/wijmo.angular2legacy.directivebase';
