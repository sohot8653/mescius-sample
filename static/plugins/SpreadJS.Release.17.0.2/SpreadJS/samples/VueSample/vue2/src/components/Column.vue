<template>
  <div class="componentContainer gc-scrollbar-thin" >
    ...
    <div class="test-btn-list">
      <label >
        <input type="checkbox" :checked="visible" @click="visible = !visible"/>visible
      </label>
      <label >
        <input type="checkbox" :checked="resizable" @click="resizable = !resizable"/>resizable
      </label>
      <br>
      <label>
        <input type="number" v-model="width" />width
      </label>
      <label>
        <input type="text" v-model="formatter" />formatter
      </label>
