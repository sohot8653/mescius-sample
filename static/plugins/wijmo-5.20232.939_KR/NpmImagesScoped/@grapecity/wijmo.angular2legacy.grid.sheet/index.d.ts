/*!
    ...
    */
/**
* {@module wijmo.angular2legacy.grid.sheet}
* Contains Angular 2 components for the <b>wijmo.grid.sheet</b> module.
*
* <b>wijmo.angular2legacy.grid.sheet</b> is an external TypeScript module that can be imported to your code
* using its ambient module name. For example:
*
* <pre>import * as wjSheet from 'wijmo/wijmo.angular2legacy.grid.sheet';
* &nbsp;
* &#64;Component({
 ...
 *
 * The <b>wj-flex-sheet</b> component may contain a {@link wijmo.angular2legacy.grid.sheet.WjSheet} child component.
*/
 ...
 * contained in a {@link wijmo.angular2legacy.grid.sheet.WjFlexSheet} component.
 *
